...
func (d *StarDictReader) decodeWithSametypesequence(data []byte) (items []*common.SearchResultItem) {
...
func (d *StarDictReader) decodeWithoutSametypesequence(data []byte) (items []*common.SearchResultItem) {
	var dataPos int
	dataSize := len(data)
...
func (d *StarDictReader) Read() (func() ([]string, []*common.SearchResultItem), error) {
	info := d.Info
	...
	data, err := ioutil.ReadFile(d.idxPath)
	...
	return func() ([]string, []*common.SearchResultItem) {
